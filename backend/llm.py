...
3. cases: Выдели ровно 5 основных уязвимостей (самых критичных для бизнеса клиента). Для каждой заполни title, vulnerability, risk, priority ("ПЕРВЫЙ ПРИОРИТЕТ", "ВТОРОЙ ПРИОРИТЕТ" или "ТРЕТИЙ ПРИОРИТЕТ"), category ("I. Серверная инфраструктура" или "II. Сеть и ИТ-поддержка"). ВАЖНО про порядок: в отчете кейсы 1-3 попадают в раздел "Серверная инфраструктура", кейсы 4-5 — в раздел "Сеть и ИТ-поддержка". Упорядочи кейсы и назначь категории так, чтобы это сходилось (первые три — category I, последние два — category II). Также придумай image_prompt — промпт на английском (до 15 слов) для генерации ИТ-векторной картинки без текста, отражающий суть кейса.
